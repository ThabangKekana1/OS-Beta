    ...
    <section className="app-surface rounded-[1.4rem] p-4">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <Link
            href={path}
            className="mt-3 block break-all rounded-xl border border-white/10 bg-black/35 px-3 py-2 text-sm text-white/78 transition hover:border-white/24 hover:text-white"
          >
            {url}
          </Link>
        </div>
