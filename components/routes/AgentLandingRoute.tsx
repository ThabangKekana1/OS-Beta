  ...
  return (
    <main className="min-h-screen bg-[#f5f5f7] text-[#1d1d1f]">
      <nav className="sticky top-0 z-50 border-b border-black/[0.06] bg-[#f5f5f7]/80 backdrop-blur-2xl">
        <div className="relative flex h-14 w-full items-center px-5 sm:px-8 lg:px-10">
          ...
          <div className="absolute left-1/2 hidden -translate-x-1/2 items-center gap-8 text-xs font-medium text-[#1d1d1f]/68 md:flex">
