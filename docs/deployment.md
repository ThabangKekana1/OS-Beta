...
| `RESEND_API_KEY` | Resend sending key for outbound dashboard email |
| `RESEND_RECEIVING_API_KEY` | Optional separate Resend key with receiving-email read access; never used for outbound sends |
